        ...
        try:
            ...
            if models_trained:
                ...
                try:
                    ...
                    # Also refresh model registry cache and invalidate prediction cache for this dataset champion
                    ...
                    await prediction_cache.invalidate_cache(dataset=dataset_name)
                    await prediction_cache.invalidate_cache(model_id=best_candidate.id)
                except Exception as e:
                    logger.warning(f"Could not invalidate online/prediction features or refresh model cache in Redis: {e}")
